...
df <- HwkGLM %>%
  mutate(across(c(col1, col6, col12), as.factor)) %>% # Convert multiple columns to factors
  mutate(across(c(col1, col6, col12), as.integer)) %>% # Convert multiple columns to integer
  mutate(across(c(col1, col6, col12), as.factor)) %>% 
  mutate(across(c(col1, col6, col12), as.factor)) %>% 
```
